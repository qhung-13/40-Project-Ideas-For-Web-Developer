...
const contentQuestion = document.getElementById("question");
const contentAnswer = document.querySelectorAll(".btn");
const btnNextQuestion = document.getElementById("next-btn");
const btnBackQuestion = document.getElementById("back-btn");
const questions = [
    {
        key: 1,
        question: "Question 1",
